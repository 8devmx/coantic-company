...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    $datos = array();
    $respuesta = 0;
    $nombre = $_FILES["downloads"]["name"];
    $nombre_tmp = $_FILES["downloads"]["tmp_name"];
    $tipo = $_FILES["downloads"]["type"];
    $tamano = $_FILES["downloads"]["size"];
    ...
    $nuevoNombre = $nombre_tem . "." . $extension;
    $directorio = "../../../uploads/industrias/";
    $ruta_archivo = "../../../uploads/industrias/" . $nuevoNombre;
