...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    if ($extension == "png" || $extension == "jpeg" || $extension == "jpg" || $extension == "gif" || $extension == "svg") {
        ...
        if (!is_dir("../../../uploads/vacantes/"))
            mkdir("../../../uploads/vacantes/", 0777);
        //comprobamos si el archivo ha subido
        if ($file && move_uploaded_file($_FILES['archivo']['tmp_name'], "../../../uploads/vacantes/" . $nombre)) {
            sleep(3); //retrasamos la petición 3 segundos
            //devolvemos el nombre del archivo para pintar la imagen
        }
        //Thumb
        create_square_image("../../../uploads/vacantes/" . $nombre, "../../../uploads/vacantes/thumb/" . $nombre, 300);
        echo $nombre;
    } else {
        echo "novalido";
    }
